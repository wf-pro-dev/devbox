  ...
  <div class="modal" on:click|stopPropagation role="dialog" aria-modal="true">
    <div class="mhdr">
      <div>
        <h2>Update file</h2>
        <p class="subtitle">
          Replacing <span class="fname">{file.file_name}</span> · currently v{file.version}
        </p>
      </div>
      ...
      >
        {#if droppedFiles?.[0]}
          <div class="chosen">
            ...
            <div class="chosen-info">
              ...
              <span class="chosen-size"
                >{(droppedFiles[0].size / 1024).toFixed(1)} KB</span
              >
            </div>
        ...
        {:else}
          <div class="drop-hint">
            ...
            <span
              >Drop the new file here, or
              <label class="browse-lbl"
                >browse
                <input
                  type="file"
                  on:change={(e) => {
